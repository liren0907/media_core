...
pub struct KnnDetector {
    bg_subtractor: opencv::core::Ptr<video::BackgroundSubtractorKNN>,
}

impl KnnDetector {
    pub fn new() -> Result<Self, AnalysisError> {
        let bg_subtractor = video::create_background_subtractor_knn_def()?;
        Ok(Self { bg_subtractor })
    }
}

impl MotionAlgorithmImpl for KnnDetector {
